...
export const enUS = {
  ...
  'atlas.subtitle':
    'A read-only control-plane map from identity to teams, tasks, agents, and reusable assets.',
  ...
  'atlas.relationExplanation':
    'Teams contain members and Agents belong to members. Tasks stack beneath their assigned Agents; Assets are owned or fixed-bound by Agents.',
