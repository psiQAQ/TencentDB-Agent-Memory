...
export const enUS = {
  ...
  'atlas.selectTeams': 'Select teams',
  'atlas.selectedTeams': '{{count}} teams selected',
  'atlas.mode.label': 'Lineage mode',
  'atlas.mode.actual': 'Actual',
  'atlas.mode.planned': 'Planned',
  'atlas.mode.all': 'All',
  ...
  'atlas.agentBreakdown': 'active {{active}} / archived {{archived}}',
  'atlas.unavailableCount': 'unavailable {{count}}',
  'atlas.refresh': 'Refresh topology',
  'atlas.enterFullscreen': 'Expand canvas',
  'atlas.exitFullscreen': 'Restore canvas',
  'atlas.dragTeam': 'Drag the whole team graph',
  'atlas.zoomOut': 'Zoom out',
  'atlas.zoomIn': 'Zoom in',
  'atlas.fit': 'Fit canvas',
  'atlas.focusTeam': 'Focus this Team',
  'atlas.focusAgent': 'Focus this Agent',
  'atlas.backToTeam': 'Back to Team',
  'atlas.backToOverview': 'Back to overview',
  'atlas.partial': '{{count}} sources are unavailable or capped; this is a partial result.',
  'atlas.lowerBound': 'lower bound',
  'atlas.selfOnlyActivity':
    'Permission-filtered: this Task shows only your activity. Hidden activity must not be interpreted as absent.',
  'atlas.aggregated':
    'The graph exceeds 500 nodes. Select a Team or Agent, then use Focus in Passport to drill down.',
  'atlas.graphLabel': 'Team relationship topology',
  'atlas.status': 'Status',
  'atlas.owner': 'Owner',
  'atlas.creator': 'Creator',
  'atlas.role': 'Role',
  'atlas.visibility': 'Visibility',
  'atlas.connections': 'Direct relationships',
  'atlas.relationGuide': 'Relationship semantics',
  'atlas.relationExplanation':
    'Actual shows L0 dialogue lineage and initialization-only events. Planned shows owners, task plans, and accessible assets. Fixed binding does not prove use.',
  'atlas.configuredRelation': 'Configured',
  'atlas.observedRelation': 'Observed at runtime',
  'atlas.retainedArchivedRelation': 'Retained for archive history; not currently effective',
  'atlas.relation.member_of': 'member of',
  'atlas.relation.belongs_to': 'belongs to Team',
  'atlas.relation.created_by': 'created by',
  'atlas.relation.owns': 'owns Agent',
  'atlas.relation.planned_for': 'planned for',
  'atlas.relation.used_in_session': 'used in session',
  'atlas.relation.records_to': 'records to',
  'atlas.relation.contains_task_l0': 'contains Task L0',
  'atlas.relation.initialized_by': 'initialized by',
  'atlas.relation.initialized_on': 'initialized on',
  'atlas.relation.fixed_binding': 'fixed binding',
  'atlas.relation.recalled_from': 'recalled from',
  'atlas.plannedAgents': 'Planned Agents',
  'atlas.actualUsers': 'Actual Users',
  'atlas.actualAgents': 'Actual Agents',
  'atlas.activityEvidence': 'Activity evidence',
  'atlas.lastActivity': 'Last activity',
  'atlas.source': 'Source',
  'atlas.memoryLayers': 'Memory layer counts',
  'atlas.statusUnavailable': 'Status unavailable',
  'atlas.openManagement': 'Open management page',
  'atlas.selectHint': 'Click a card to inspect it. Click empty canvas space to clear.',
  'atlas.loading': 'Building the team topology…',
  'atlas.loadFailed': 'Unable to load Team Atlas',
  'atlas.retry': 'Retry',
  'atlas.noTeams': 'No active Team is available for this account.',
  'atlas.type.all': 'All assets',
  'atlas.type.identity': 'Identity',
  'atlas.type.team': 'Team',
  'atlas.type.task': 'Task',
  'atlas.type.agent': 'Agent',
  'atlas.type.skill': 'Skill',
  'atlas.type.llm_wiki': 'Wiki',
  'atlas.type.code_graph': 'Code Graph',
  'atlas.type.chat_memory': 'Chat Memory',
  ...
  'menu.desc.owned_resources': 'Inspect ownership and permanently purge',
  ...
  'users.create.customKeyHint':
    'When off, Core generates it. Copy it on demand from the user’s Key list after creation.',
  'users.create.success': 'User {{username}} created; copy the initial Key from the Key list',
  ...
  'task.delete.noPermission':
    'You are not the creator of task "{{title}}" and cannot delete it. Creator: {{creator}}',
  'task.edit': 'Edit',
  ...
  'task.statusSwitch.tooltip.cannotEdit': 'Only the task creator can toggle its status',
  'task.creator': 'Creator',
  'task.creator.tooltip': 'Task creator; only the creator can edit or delete this task',
  ...
  'task.noPermissionEdit': 'You are not the creator of this task and cannot modify it.',
  ...
  'apiKey.table.keyPrefix': 'Masked Key',
  'apiKey.table.createdAt': 'Created At',
  'apiKey.table.expiresAt': 'Expires At',
  'apiKey.table.actions': 'Actions',
  'apiKey.copy.success': 'Key copied to clipboard',
  'apiKey.copy.invalidResponse': 'Unable to retrieve this Key',
  'apiKey.copy.unavailable': 'Clipboard access is unavailable in this browser',
  ...
  'apiKey.scope.member': 'Member',
  'apiKey.scope.member.placeholder': 'Search username, display name, or User ID',
  'apiKey.role.owner': 'owner',
  'apiKey.role.admin': 'admin',
  'apiKey.role.member': 'member',
  'apiKey.role.reviewer': 'reviewer',
  'apiKey.endpoint.title': 'Client Access Configuration',
  'apiKey.endpoint.current': 'Current instance: ',
  'apiKey.endpoint.model': 'Active model: ',
