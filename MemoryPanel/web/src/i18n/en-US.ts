...
export const enUS = {
  ...
  'atlas.relationExplanation': 'Tasks are assigned only to Agents; Assets are owned or fixed-bound by Agents. The chain is Task → Agent → Asset, with no direct Task → Asset edge.',
  ...
  'atlas.selectHint': 'Hover for a preview. Click to lock the Passport.',
