...
export const enUS = {
  ...
  'atlas.subtitle': 'A read-only control-plane map from identity to teams, tasks, agents, and reusable assets.',
  ...
  'atlas.partial': '{{count}} sources are unavailable; this is a partial result.',
  'atlas.aggregated': 'The graph exceeds the display limit. Select a Team or Agent to drill down.',
  ...
  'atlas.currentIdentity': 'Current signed-in identity',
  'atlas.connections': 'Direct relationships',
  'atlas.relationGuide': 'Relationship semantics',
  'atlas.relationExplanation': 'Teams contain members and Agents belong to members. Tasks stack beneath their assigned Agents; Assets are owned or fixed-bound by Agents.',
  'atlas.relation.member_of': 'member of',
  'atlas.relation.contains': 'contains',
  'atlas.relation.assigned_to': 'assigned to',
  'atlas.relation.owns': 'owns',
