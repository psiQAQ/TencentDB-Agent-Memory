...
export const zhCN = {
  ...
  'menu.desc.team_atlas': 'Team / Task / Agent / Asset 拓扑',
  'atlas.title': '团队全景',
  'atlas.summary': '拓扑汇总',
  'atlas.mineVisible': '我的 / 可见',
  'atlas.search': '搜索名称或 ID',
  'atlas.assetType': '资产类型',
  'atlas.selectTeams': '选择团队',
  'atlas.selectedTeams': '已选 {{count}} 个团队',
  'atlas.mode.label': '谱系模式',
  ...
  'atlas.agentBreakdown': '活跃 {{active}} / 归档 {{archived}}',
  'atlas.unavailableCount': '不可用 {{count}}',
  'atlas.refresh': '刷新拓扑',
  'atlas.enterFullscreen': '全屏显示画布',
  'atlas.exitFullscreen': '恢复画布',
  'atlas.dragTeam': '拖动整个团队拓扑',
  'atlas.zoomOut': '缩小',
  'atlas.zoomIn': '放大',
  'atlas.fit': '适应画布',
  'atlas.focusTeam': '聚焦此 Team',
  'atlas.focusAgent': '聚焦此 Agent',
  'atlas.backToTeam': '返回 Team',
  'atlas.backToOverview': '返回全景',
  'atlas.partial': '{{count}} 个数据源暂不可用或已达上限，当前展示为部分结果。',
  'atlas.lowerBound': '下界',
  'atlas.selfOnlyActivity':
    '权限已裁剪：此 Task 当前仅展示你自己的实际活动，未显示其他成员不代表不存在。',
  'atlas.aggregated':
    '节点超过 500 个。选择 Team 或 Agent 后，在 Passport 中点击聚焦即可继续下钻。',
  'atlas.graphLabel': '团队关系拓扑图',
  'atlas.status': '状态',
  'atlas.owner': 'Owner',
  'atlas.creator': '创建者',
  'atlas.role': '角色',
  'atlas.visibility': '可见性',
  'atlas.connections': '直接关系',
  'atlas.relationGuide': '关系语义',
  'atlas.relationExplanation':
    'Actual 显示 L0 对话谱系与仅初始化事件；Planned 显示 Owner、任务规划和可访问资产。固定绑定不代表实际使用。',
  'atlas.configuredRelation': '配置关系',
  'atlas.observedRelation': '运行态观测',
  'atlas.retainedArchivedRelation': '归档保留关系，当前非有效',
  'atlas.relation.member_of': '成员属于',
  'atlas.relation.belongs_to': '属于 Team',
  'atlas.relation.created_by': '创建者',
  'atlas.relation.owns': '拥有 Agent',
  'atlas.relation.planned_for': '规划执行',
  'atlas.relation.used_in_session': '会话身份',
  'atlas.relation.records_to': '写入记忆',
  'atlas.relation.contains_task_l0': '包含 Task L0',
  'atlas.relation.initialized_by': '由身份初始化',
  'atlas.relation.initialized_on': '在 Agent 初始化',
  'atlas.relation.fixed_binding': '固定绑定',
  'atlas.relation.recalled_from': '实际召回',
  'atlas.plannedAgents': '规划 Agent',
  'atlas.actualUsers': '实际 User',
  'atlas.actualAgents': '实际 Agent',
  'atlas.activityEvidence': '实际活动证据',
  'atlas.lastActivity': '最近活动',
  'atlas.source': '来源',
  'atlas.memoryLayers': '记忆分层数量',
  'atlas.statusUnavailable': '统计暂不可用',
  'atlas.openManagement': '进入现有管理页面',
  'atlas.selectHint': '点击卡片查看摘要；点击画布空白处清空。',
  'atlas.loading': '正在构建团队拓扑…',
  'atlas.loadFailed': '团队拓扑加载失败',
  'atlas.retry': '重新加载',
  'atlas.noTeams': '当前账号没有可用的 active Team。',
  'atlas.type.all': '全部资产',
  ...
  'users.create.customKeyHint': '关闭时由 Core 自动生成；创建后可在该用户的 Key 列表中按需复制。',
  'users.create.success': '用户 {{username}} 已创建；可在 Key 列表中复制初始 Key',
  ...
  'resources.transfer.targetAgent': '接收资产的 Agent',
  'resources.transfer.targetAgentHint':
    '本次独立转移的 Skill、Wiki、Code Graph、Chat Memory 将共用这个接收 Agent；ownership 与固定绑定会一起迁移。',
  'resources.transfer.noTargetAgent':
    '该用户没有 active Agent；确认转移后将按 Team 默认模板为其创建一个 Agent。',
  'resources.desc':
  ...
  'task.statusSwitch.tooltip.cannotEdit': '仅 task 创建者可切换状态',
  'task.creator': '创建者',
  'task.creator.tooltip': 'Task 创建者；仅创建者可编辑或删除本 task',
  ...
  'task.noPermissionEdit': '你不是该 task 的创建者，无权修改。',
  ...
  'apiKey.table.keyPrefix': '脱敏 Key',
  'apiKey.table.createdAt': '创建时间',
  'apiKey.table.expiresAt': '失效时间',
  'apiKey.table.actions': '操作',
  'apiKey.copy.success': 'Key 已复制到剪贴板',
  'apiKey.copy.invalidResponse': '无法读取该 Key',
  'apiKey.copy.unavailable': '浏览器未开放剪贴板写入功能',
  'apiKey.revoked': '已吊销',
  ...
  'apiKey.scope.member': '成员信息',
  'apiKey.scope.member.placeholder': '搜索用户名、显示名或 User ID',
  'apiKey.role.owner': 'owner',
  'apiKey.role.admin': 'admin',
  'apiKey.role.member': 'member',
  'apiKey.role.reviewer': 'reviewer',
  'apiKey.endpoint.title': '客户端接入配置',
  'apiKey.endpoint.current': '当前实例：',
  'apiKey.endpoint.model': '实际模型：',
